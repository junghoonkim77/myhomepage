   ...
   <table >
    <h4><?php echo date("m").'/'.date("d").'('.$days[$weekday].') MIT 판매기회발굴 실적'; ?></h4>
        ...
        <tbody>
            ...
            <td class="succeed1"><?php echo $mu1[4] ?></td>
        </tr>
            ...
            <td class="succeed1"><?php echo $mu2[4] ?></td>
        </tr>
            ...
            <td class="succeed1"><?php echo $mu3[4] ?></td>
        </tr>
            ...
            <td class="succeed1"><?php echo $mu4[4] ?></td>
        </tr>
            ...
            <td class="succeed1"><?php echo $mu5[4] ?></td>
        </tr>
            ...
            <td class="succeed1"><?php echo $tong[4] ?></td>
        </tr>
    ...
    <h5>Sales 입력시간</h5>
    <p class="teamcom" >무선1팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $mu1[5] ?></span></p>
    <p class="teamcom">무선2팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $mu2[5] ?></span></p>
    <p class="teamcom" >무선3팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $mu3[5] ?></span></p>
    <p class="teamcom">무선4팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $mu4[5] ?></span></p>
    <p class="teamcom">무선5팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $mu5[5] ?></span></p>
    <p class="teamcom">통화품질팀 입력시간:<span class="colordiv" data-col=<?php echo $days[$weekday]; ?>><?php echo $tong[5] ?></span></p>
