...
character = pygame.image.load('C:/Users/82102/Documents/GitHub/myhomepage/Pygame_basic/정훈기은.jpg')
...
#똥 만들기 코드 
ddong = pygame.image.load('C:/Users/82102/Documents/GitHub/myhomepage/Pygame_basic/게임용똥.jfif')
...
#키보드 마우스 이벤트를 처리하는 곳
    ...
    if ddong_y_pos > screen_height: #똥이 바닥에 떨어지면 또 똥을 만들어 내는 것 
        ddong_y_pos = 0
        ddong_x_pos = random.randint(0,screen_width - ddong_width)
  ...
  # 충돌처리를 위한 rect 정보 업데이트 
    ...
    screen.blit(ddong,(ddong_x_pos,ddong_y_pos)) #적그리기
