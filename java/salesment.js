...
new Salesment("banron","휴대폰 바꿀때 안됐어요~! 아직 멀쩡해요~!",
`오히려 나중에 고장나서 급하게 바꾸시려고 하면 기존폰은 폰대로 
고장나서 사용도 못하시고, 기기 바꾸시는 동안 급한데 이용 못하실수
있거든요. 특히 LG폰 사용중이신데 LG폰이 AS도 쉽지 않고 차라리 
지금 본사 특별한인도 받고 미리 폰 바꾸시고 혜택 많이 챙기시는게
맞을것 같아요~!`),
