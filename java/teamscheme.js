...
new Schedule("9일","수",".",".",".",".",".",".",".","박정범",".","9일","수","정기평가"),
new Schedule("10일","목","최아람",".",".","이한기",".",".","1400(남)","백금옥",".","10일","목","."),
...
new Schedule("16일","수",".",".",".",".",".",".",".","이한기",".","16일","수","레벨업교육16~18"),
new Schedule("17일","목","박정범",".",".",".",".",".",".","최민지",".","17일","목","."),
new Schedule("18일","금","박정범",".",".","최아람",".",".","1030(남)","백금옥",".","18일","금","."),
...
new Schedule("23일","수","최민지",".",".","박주영",".",".","1400(유)","이한기",".","23일","수","정범15:30네일아트"),
