...
new Schedule("9일","목","이윤복(변경예정)","이진우",".",".",".",".",".","최민지",".","9일","목","오스탓시상식 /깨움회"),
...
new Schedule("24일","금",".",".",".","이윤복",".",".","1500(남)","박정범",".","24일","금","."),
...
new Schedule("29일","수","백금옥",".",".","최민지",".",".","1300(유)","이한기",".","29일","수","."),
new Schedule("30일","목","김정훈",".",".","박주영",".",".","1030(유)","백금옥",".","30일","목","."),
new Schedule("31일","금",".",".",".","김정훈",".",".","1500(남)","이한기 ",".","31일","금","."),
  ]           
