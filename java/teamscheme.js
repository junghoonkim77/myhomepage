...
new Schedule("8일","토",".",".",".",".",".",".",".",".",".","8일","토","."),   
new Schedule("9일","일",".",".",".",".",".",".",".",".",".","9일","일","."),   
new Schedule("10일","월","이진우",".",".",".",".",".",".",".",".","10일","월","업무지식평가 / 12:30분식사"),   
new Schedule("11일","화",".",".",".",".",".",".",".",".",".","11일","화","."),   
new Schedule("12일","수","이윤복",".",".","백금옥",".",".","1030(유)",".",".","12일","수","정범 네일 15:30~"),   
new Schedule("13일","목","이한기","김정훈",".",".",".",".",".",".",".","13일","목","."),   
new Schedule("14일","금","이한기",".",".","이윤복",".",".","1400(유)",".",".","14일","금","12:30분식사 종료"),   
new Schedule("15일","토",".",".",".",".",".",".",".",".",".","15일","토","."),   
new Schedule("16일","일",".",".",".",".",".",".",".",".",".","16일","일","."),   
new Schedule("17일","월",".",".",".",".",".",".",".",".",".","17일","월","12:00 식사 시작"),   
...
new Schedule("22일","토",".",".",".",".",".",".",".",".",".","22일","토","."),   
new Schedule("23일","일",".",".",".",".",".",".",".",".",".","23일","일","."),   
new Schedule("24일","월",".",".",".",".",".",".",".",".",".","24일","월","13:30분 식사"),   
