...
new Schedule("19일","월",".",".",".",".",".",".",".","박정범",".","19일","월","."),
new Schedule("20일","화","백금옥",".",".",".",".",".",".","이한기",".","20일","화","."),
new Schedule("21일","수","박정범",".",".","박주영",".",".","1030남","최민지",".","21일","수","."),
new Schedule("22일","목","최아람",".",".",".",".",".",".","박정범",".","22일","목","."),
new Schedule("23일","금","박주영",".",".","최아람",".",".","1030유","김정훈",".","23일","금","."),
...
var schedule7 =[
    ...
    new Schedule("20일","목","김정훈",".",".",".",".",".",".",".",".","20일","목","."),
    new Schedule("21일","금","김정훈",".",".",".",".",".",".",".",".","21일","금","."),
    new Schedule("22일","토",".",".",".",".",".",".",".",".",".","22일","토","."),
    new Schedule("23일","일",".",".",".",".",".",".",".",".",".","23일","일","."),
    new Schedule("24일","월",".",".",".",".",".",".",".",".",".","24일","월","."),
    new Schedule("25일","화","이윤복",".",".",".",".",".",".",".",".","25일","화","."),
    new Schedule("26일","수","이윤복",".",".",".",".",".",".",".",".","26일","수","."),
    new Schedule("27일","목","박주영",".",".",".",".",".",".",".",".","27일","목","."),
    new Schedule("28일","금","박주영",".",".",".",".",".",".",".",".","28일","금","."),
...
var schedule8 =[
    ...
    new Schedule("3일","목","이한기",".",".",".",".",".",".",".",".","3일","목","."),
    new Schedule("4일","금","이한기",".",".",".",".",".",".",".",".","4일","금","."),
    new Schedule("5일","토",".",".",".",".",".",".",".",".",".","5일","토","."),
    new Schedule("6일","일",".",".",".",".",".",".",".",".",".","6일","일","."),
    new Schedule("7일","월","이진우",".",".",".",".",".",".",".",".","7일","월","."),
    new Schedule("8일","화","이진우",".",".",".",".",".",".",".",".","8일","화","."),
    new Schedule("9일","수","이진우",".",".",".",".",".",".",".",".","9일","수","."),
    new Schedule("10일","목","최아람",".",".",".",".",".",".",".",".","10일","목","."),
    new Schedule("11일","금","최아람",".",".",".",".",".",".",".",".","11일","금","."),
    ...
    new Schedule("17일","목","박정범",".",".",".",".",".",".",".",".","17일","목","."),
    new Schedule("18일","금","박정범",".",".",".",".",".",".",".",".","18일","금","."),
