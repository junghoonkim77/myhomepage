...
var schedule9 = [
    ...
    new Schedule("5일","화","이윤복",".",".","이한기",".",".","1400(유)","백금옥",".","5일","화","."),
    new Schedule("6일","수","김정훈(반)",".",".",".",".",".",".","박정범",".","6일","수","정기평가"),
    new Schedule("7일","목","백금옥",".",".","최아람",".",".","1300(남)","이한기",".","7일","목","."),
    new Schedule("8일","금","백금옥",".",".","이진우",".",".","1300(유)","김정훈",".","8일","금","."),
    new Schedule("9일","토",".",".",".",".",".",".",".","(제)최민지",".","9일","토","."),
    new Schedule("10일","일",".",".",".",".",".",".",".",".",".","10일","일","."),
    new Schedule("11일","월",".",".",".",".",".",".",".","백금옥",".","11일","월","."),
    new Schedule("12일","화",".",".",".",".",".",".",".","이한기",".","12일","화","."),
    new Schedule("13일","수","최민지",".",".","이윤복",".",".","1300(유)","박정범",".","13일","수","정범네일15:30"),
    ...
    new Schedule("21일","목","김정훈(반)",".",".","백금옥",".",".","1400(남)","최민지",".","21일","목","이윤복 네일아트 15:00"),
