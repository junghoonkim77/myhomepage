...
new Schedule("2일","토",".",".",".",".",".",".",".","(서)",".","2일","토","."),
new Schedule("3일","일",".",".",".",".",".",".",".",".",".","3일","일","."),
new Schedule("4일","월",".",".",".",".",".",".",".",".",".","4일","월","."),
new Schedule("5일","화","이진우",".",".",".",".",".",".",".",".","5일","화","업무지식평가"),
new Schedule("6일","수","이진우",".",".",".",".",".",".",".",".","6일","수","."),
new Schedule("7일","목","이진우",".",".",".",".",".",".",".",".","7일","목","."),
new Schedule("8일","금",".",".",".",".",".",".",".",".",".","8일","금","."),
new Schedule("9일","토",".",".",".",".",".",".",".",".",".","9일","토","."),
new Schedule("10일","일",".",".",".",".",".",".",".","(서)",".","10일","일","."),
new Schedule("11일","월",".",".",".",".",".",".",".",".",".","11일","월","."),
new Schedule("12일","화",".",".",".",".",".",".",".",".",".","12일","화","."),
new Schedule("13일","수","백금옥",".",".",".",".",".",".",".",".","13일","수","."),
new Schedule("14일","목","백금옥",".",".",".",".",".",".",".",".","14일","목","."),
new Schedule("15일","금","백금옥",".",".",".",".",".",".",".",".","15일","금","."),
new Schedule("16일","토",".",".",".",".",".",".",".","(서)",".","16일","토","."),
...
new Schedule("28일","목","최민지",".",".",".",".",".",".",".",".","28일","목","."),
new Schedule("29일","금","최민지",".",".",".",".",".",".",".",".","29일","금","."),
new Schedule("30일","토",".",".",".",".",".",".",".","(서)",".","30일","토","."),
