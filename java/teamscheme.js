...
var schedule6 = [
    ...
    new Schedule("7일","금","이한기",".",".","백금옥",".",".","1300(유)","김정훈",".","7일","금","15:30 ~ 민지 네일"),   
    new Schedule("8일","토",".",".",".",".",".",".",".","(서)김정훈",".","8일","토","."),   
    new Schedule("9일","일",".",".",".",".",".",".",".",".",".","9일","일","."),   
    new Schedule("10일","월",".",".",".",".",".",".",".","최민지",".","10일","월","."),   
    new Schedule("11일","화",".",".",".",".",".",".",".","백금옥",".","11일","화","통품정기평가"),   
    new Schedule("12일","수","최민지",".",".","최아람",".",".","1030(유)","박정범",".","12일","수","."),   
