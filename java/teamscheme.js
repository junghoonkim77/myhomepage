...
var schedule11 =[
    ...
    new Schedule("5일","일",".",".",".",".",".",".",".",".",".","5일","일","."),
    new Schedule("6일","월","최아람",".",".",".",".",".",".","최민지",".","6일","월","."),
    new Schedule("7일","화","최아람",".",".",".",".",".",".","박정범",".","7일","화","."),
    new Schedule("8일","수",".",".",".",".",".",".",".","최민지",".","8일","수","생일의 날"),
    new Schedule("9일","목","백금옥",".",".","박정범",".",".","1300(유)","이한기",".","9일","목","."),
    new Schedule("10일","금","백금옥",".",".","이한기",".",".","1400(남)","김정훈",".","10일","금","의료비마감"),
