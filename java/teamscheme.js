...
//4월
var schedule4 = [
    new Schedule("1일","화",".",".",".",".",".",".",".",".",".","1일","화","채팅상담개시"),   
new Schedule("2일","수",".",".",".",".",".",".",".",".",".","2일","수","."),   
new Schedule("3일","목",".",".",".",".",".",".",".",".",".","3일","목","."),   
new Schedule("4일","금",".",".",".",".",".",".",".",".",".","4일","금","채팅상담종료"),   
new Schedule("5일","토",".",".",".",".",".",".",".",".",".","5일","토","."),   
new Schedule("6일","일",".",".",".",".",".",".",".",".",".","6일","일","."),   
new Schedule("7일","월","백금옥",".",".",".",".",".",".",".",".","7일","월","업무지식평가"),   
new Schedule("8일","화","백금옥",".",".",".",".",".",".",".",".","8일","화","."),   
new Schedule("9일","수","백금옥",".",".",".",".",".",".",".",".","9일","수","."),   
new Schedule("10일","목","백금옥",".",".",".",".",".",".",".",".","10일","목","."),   
new Schedule("11일","금","백금옥",".",".",".",".",".",".",".",".","11일","금","."),   
...
var schedule6 = [
    ...
    new Schedule("12일","목","김정훈",".",".",".",".",".",".",".",".","12일","목","."),   
    new Schedule("13일","금","김정훈",".",".",".",".",".",".",".",".","13일","금","."),   
