...
new Schedule("6일","수","이진우",".",".",".",".",".",".","박정범",".","6일","수","."),
new Schedule("7일","목","이진우",".",".","백금옥",".",".","1300(남)","최민지",".","7일","목","."),
new Schedule("8일","금",".",".",".","이한기",".",".","1300(유)","김정훈",".","8일","금","."),
new Schedule("9일","토",".",".",".",".",".",".",".","(제)최민지",".","9일","토","."),
new Schedule("10일","일",".",".",".",".",".",".",".","(서)이진우","(서)이한기","10일","일","."),
new Schedule("11일","월",".",".",".",".",".",".",".","최민지",".","11일","월","."),
new Schedule("12일","화",".",".",".",".",".",".",".","이한기",".","12일","화","통화품질정기평가"),
new Schedule("13일","수","백금옥",".",".","박정범",".",".","1130(남)","박정범",".","13일","수","."),
new Schedule("14일","목","백금옥",".",".","최민지",".",".","1300(남)","최민지",".","14일","목","."),
...
new Schedule("20일","수","김정훈",".",".",".",".",".",".","박정범",".","20일","수","."),
new Schedule("21일","목","박정범",".",".",".",".",".",".","최민지",".","21일","목","."),
new Schedule("22일","금","이한기",".",".","이진우",".",".","1030(남)","김정훈",".","22일","금","민지nail15:30"),
new Schedule("23일","토",".",".",".",".",".",".",".","(제)박정범",".","23일","토","."),
new Schedule("24일","일",".",".",".",".",".",".",".","(제)김정훈","(제)이한기","24일","일","."),
new Schedule("25일","월",".",".",".",".",".",".",".","박정범",".","25일","월","."),
new Schedule("26일","화",".",".",".",".",".",".",".","이한기",".","26일","화","."),
new Schedule("27일","수","최민지",".",".","이윤복",".",".","1030(남)","최민지(변경예정)",".","27일","수","."),
new Schedule("28일","목","최민지",".",".","김정훈",".",".","1300(유)","백금옥",".","28일","목","."),
...
var schedule8 =[
    ...
    new Schedule("5일","월","이윤복",".",".",".",".",".",".",".",".","5일","월","."),
    new Schedule("6일","화","이윤복",".",".",".",".",".",".",".",".","6일","화","업무지식평가"),
