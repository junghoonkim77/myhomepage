...
new Schedule("9일","일",".",".",".",".",".",".",".",".",".","9일","일","."),
new Schedule("10일","월","최아람",".",".",".",".",".",".","최민지",".","10일","월","."),
new Schedule("11일","화",".",".",".",".",".",".",".","이한기",".","11일","화","통품 정기평가 예정일"),
new Schedule("12일","수","이한기",".",".","박정범",".",".","1030(남)","박정범",".","12일","수","."),
...
new Schedule("21일","금","김정훈",".",".","이윤복",".",".","1300(남)","최민지",".","21일","금","."),
