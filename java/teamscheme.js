...
new Schedule("5일","수",".",".",".","박정범","백금옥",".","1030유/1500남",".",".","5일","수","민지네일아트"),   
new Schedule("6일","목","최민지",".",".","박주영",".",".","1300남",".",".","6일","목","."),   
...
new Schedule("13일","목",".",".",".",".",".",".",".",".",".","13일","목","통품업무지식평가"),   
...
new Schedule("21일","금",".",".",".","김지훈",".",".","1300유",".",".","21일","금","."),   
new Schedule("22일","토",".",".",".",".",".",".",".",".",".","22일","토","."),   
new Schedule("23일","일",".",".",".",".",".",".",".",".",".","23일","일","."),   
new Schedule("24일","월",".",".",".",".",".",".",".",".",".","24일","월","."),   
new Schedule("25일","화",".",".",".",".",".",".",".",".",".","25일","화","."),   
