    ...
    <script>
         ...
         // 엑셀파일에 붙여 넣을 내용 append하기
          ...
          $('.dailyexcel').on('click',function(){
           const excel = $(this).siblings("td:nth-child(2)").text();
           const excel1 = $(this).siblings("td:nth-child(4)").text();
           const excel2 = $(this).siblings("td:nth-child(6)").text();
            console.log(excel);
           ...
           $('#dailyRepot').append("<tr><td style='border:none;'>"+excel+"</td>"
            ...
            +"<td style='border:none;'>"+excel2+"</td></tr>");
           })
